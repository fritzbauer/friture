...
class Ui_Settings_Dialog(object):
    ...
    def setupUi(self, Settings_Dialog):
        ...
        self.label_mic_sensitivity = QtWidgets.QLabel(Settings_Dialog)
        self.label_mic_sensitivity.setObjectName("label_mic_sensitivity")
        self.verticalLayout_5.addWidget(self.label_mic_sensitivity)

        self.spinBox_mic_sensitivity = QtWidgets.QSpinBox(Settings_Dialog)
        self.spinBox_mic_sensitivity.setKeyboardTracking(False)
        self.spinBox_mic_sensitivity.setMinimum(-100)
        self.spinBox_mic_sensitivity.setMaximum(200)
        self.spinBox_mic_sensitivity.setProperty("value", 20)
        self.spinBox_mic_sensitivity.setObjectName("spinBox_mic_sensitivity")
